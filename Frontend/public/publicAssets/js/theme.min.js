    ...
    e.fn.downCount = function (t, o) {
      ...
      var n = this,
        ...
        i = setInterval(function () {
          ...
          if (0 > e)
            return clearInterval(i), void (o && "function" == typeof o && o());
          var t = 6e4,
            s = 60 * t,
            l = 24 * s,
            d = Math.floor(e / l),
          ...
          n.find(".days").text(d),
            n.find(".hours").text(h),
            n.find(".minutes").text(c),
            n.find(".seconds").text(f),
            n.find(".days_ref").text(p),
            n.find(".hours_ref").text(u),
            n.find(".minutes_ref").text(g),
            n.find(".seconds_ref").text(m);
        }, 1e3);
    };
  })(jQuery),
  $(".countdown").downCount({
